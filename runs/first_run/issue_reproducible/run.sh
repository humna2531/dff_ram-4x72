...
export LIB_SYNTH_COMPLETE_NO_PG='./tmp/synthesis/4-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib';
export LIB_SYNTH_NO_PG='./tmp/synthesis/4-trimmed.no_pg.lib';
...
export synth_report_prefix='./reports/synthesis/4-synthesis';
